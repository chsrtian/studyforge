...
<head>
    ...
    <title>{{ config('app.name', 'StudyForge') }} - Terms</title>
    ...
    <div class="mx-auto w-full max-w-5xl px-6 py-8 sm:px-10">
        ...
        <main class="space-y-6 py-8">
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-indigo-700 dark:text-indigo-300">Terms</p>
                <h1 class="mt-2 text-3xl font-extrabold tracking-tight">Terms of Service</h1>
                <p class="mt-4 text-sm leading-7 text-slate-700 dark:text-slate-200">
                    By using StudyForge, you agree to use the platform responsibly for lawful educational purposes,
                    respect account security, and avoid abusive usage that affects service quality.
                </p>
            </section>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                ...
                <ul class="mt-4 list-disc space-y-2 pl-6 text-sm leading-6 text-slate-700 dark:text-slate-200">
                    ...
                    <li>Do not attempt to bypass limits, authentication controls, or API protections.</li>
                    <li>Do not upload harmful content, malware, or unauthorized material.</li>
                </ul>
            </section>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900">
                ...
                <p class="mt-4 text-sm leading-7 text-slate-700 dark:text-slate-200">
                    StudyForge may update features, rate limits, and infrastructure over time to improve quality,
                    security, and reliability. Maintenance windows and temporary interruptions may occur.
                </p>
            </section>
        </main>
        ...
        <x-public-footer
            ...
            yearLabel="StudyForge. Terms of Service."
        />
    </div>
</body>
</html>
